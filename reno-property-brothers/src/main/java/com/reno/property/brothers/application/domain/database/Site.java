...
public class Site {
	...
	@Id
	@Column(name = "siteUniqueId")
	@GeneratedValue(strategy=GenerationType.AUTO, generator="siteUniqueId")
	@SequenceGenerator(name="siteUniqueId", sequenceName="siteUniqueId")
